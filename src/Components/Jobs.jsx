...
const Jobs = () => {
  return (
    ...
    <div className='p-4'>
      ...
      <div className='py-2 border-greenish border-b-[3px] w-[145px]'>
        <h1 className='font-semibold text-[25px]'>Latest jobs</h1>
      </div>

      <div className='job lg:py-10 w-full h-full gap-10 mx-auto grid grid-cols-1 lg:grid-cols-4'>


        {jobsData.map((job, index) => {
          return (

            <div className='group group/item singleJob p-[20px] bg-greyish rounded-[10px] shadow-sm shadow-greyish-400/700 hover:shadow-md' key={index}>

              <span className='flex justify-between items-center gap-4'>

                <h1 className='text-[16px] font-semibold text-brownish hover:text-greenish'>{job.title}</h1>

                <span className='flex items-center text-brownbish gap-2 group-hover:text-textColor'>
                  <Clock size={16} /> <span className='text-sm'>{job.time}</span>
                </span>

              </span>

              <h6 className='text-brownbish border-b-[2px] pb-[20px] group-hover:text-textColor'>{job.location}</h6>
              ...
              <div className='flex items-center gap-3 mb-6'>
                ...
                <div>
                  ...
                  <h6 className='text-brownbish text-[12px]'>24 Jan, 2024</h6>
                </div>
